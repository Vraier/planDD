...
Number of cache collisions: 6778
Number of cache deletions: 1733
Cache used slots = 53.45% (expected 51.15%)
...
Total number of nodes reclaimed: 1708
...
Maximum resident size            =  6920K

Virtual memory limit             = unlimited (unlimited)
Major page faults = 0
Minor page faults = 1075
Swaps = 0
Input blocks = 0
Output blocks = 8
