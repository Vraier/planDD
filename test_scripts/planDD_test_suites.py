...
def best_19_7_big_test():
    ...
    map_no_t_binary =  {
        ...
        "$timesteps" : -1,
        "$mode" : "build_bdd",
        "$addition_flags" : " --build_order rympec:: --exact_one_constraint --binary_encoding ",
    }
    map_no_t_no_reorder =  {
        "$timeout" : "300s",
        "$timesteps" : -1,
        "$mode" : "build_bdd",
        "$addition_flags" : " --build_order rympec:: --exact_one_constraint --no_reordering ",
    }
    map_no_t_no_reorder_binary =  {
        "$timeout" : "300s",
        "$timesteps" : -1,
        "$mode" : "build_bdd",
        "$addition_flags" : " --build_order rympec:: --exact_one_constraint --no_reordering --binary_encoding ",
    }

    map_group_action =  {
        "$timeout" : "300s",
        "$mode" : "build_bdd",
        "$addition_flags" : " --build_order igx:rympec: --exact_one_constraint --group_actions ",
    }
    map_group_var =  {
        "$timeout" : "300s",
        "$mode" : "build_bdd",
        "$addition_flags" : " --build_order igx:rympec: --exact_one_constraint --group_variables ",
    }
    map_group_varsmall =  {
        "$timeout" : "300s",
        "$mode" : "build_bdd",
        "$addition_flags" : " --build_order igx:rympec: --exact_one_constraint --group_variables_small ",
    }
    map_group_var_action =  {
        "$timeout" : "300s",
        "$mode" : "build_bdd",
        "$addition_flags" : " --build_order igx:rympec: --exact_one_constraint  --group_actions --group_variables ",
    }
    map_group_varsmall_action =  {
        "$timeout" : "300s",
        "$mode" : "build_bdd",
        "$addition_flags" : " --build_order igx:rympec: --exact_one_constraint  --group_actions --group_variables_small ",
    }

    map_group_action_binary =  {
        "$timeout" : "300s",
        "$mode" : "build_bdd",
        "$addition_flags" : " --build_order igx:rympec: --exact_one_constraint --group_actions --binary_encoding ",
    }
    map_group_var_binary =  {
        "$timeout" : "300s",
        "$mode" : "build_bdd",
        "$addition_flags" : " --build_order igx:rympec: --exact_one_constraint --group_variables --binary_encoding ",
    }
    map_group_varsmall_binary =  {
        "$timeout" : "300s",
        "$mode" : "build_bdd",
        "$addition_flags" : " --build_order igx:rympec: --exact_one_constraint --group_variables_small --binary_encoding ",
    }
    map_group_var_action_binary =  {
        "$timeout" : "300s",
        "$mode" : "build_bdd",
        "$addition_flags" : " --build_order igx:rympec: --exact_one_constraint  --group_actions --group_variables --binary_encoding ",
    }
    map_group_varsmall_action_binary =  {
        "$timeout" : "300s",
        "$mode" : "build_bdd",
        "$addition_flags" : " --build_order igx:rympec: --exact_one_constraint  --group_actions --group_variables_small --binary_encoding ",
    }
